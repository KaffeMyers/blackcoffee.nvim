local ts = require("blackcoffee.treesitter")
...
function M.invert_color(color)
  local hsluv = require("blackcoffee.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  local group = vim.api.nvim_create_augroup("blackcoffee", { clear = true })
