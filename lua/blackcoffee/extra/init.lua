...
function M.setup()
  M.docs()
  local blackcoffee = require("blackcoffee")
  ...
  for extra, info in pairs(M.extras) do
    package.loaded["blackcoffee.extra." .. extra] = nil
    local plugin = require("blackcoffee.extra." .. extra)
    for style, style_name in pairs(styles) do
      blackcoffee.setup({ style = style })
      blackcoffee.load({ style = style })
      vim.cmd.colorscheme('blackcoffee-' .. style)
      local colors = require("blackcoffee.colors").setup({ transform = true })
      local fname = extra .. "/blackcoffee_" .. style .. "." .. info.ext
      colors["_upstream_url"] = "https://github.com/folke/blackcoffee.nvim/raw/main/extras/" .. fname
